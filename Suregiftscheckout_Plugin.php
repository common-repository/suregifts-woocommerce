...
class Suregiftscheckout_Plugin extends Suregiftscheckout_LifeCycle {
	...
	return $this->_validationUrl[$country][$mode=="true"?"test":"live"];
    }

    public function getConfirmationUrl($country,$mode){
	return $this->_confirmationUrl[$country][$mode=="true"?"test":"live"];
    }
    ...
    public function getOptionMetaData() {
        ...
        return array(
            ...
            'TestMode' => array(__('Test Mode', 'suregiftscheckout-plugin'), 'true', 'false'),
             'Country' => array(__('Country', 'suregiftscheckout-plugin'), 'KEN','NGR')
        );
    }
...
function  suregifts_woocommerce_after_cart_table(){
   ...
   $country=$this->getOption('Country');
      ...
      $ch = curl_init($this->getValidationUrl($country,$mode)."?vouchercode=".$coupon_code); 
  ...
  $username =$this->getOption('UsernameInput');
	 ...
	 $country=$this->getOption('Country');
      ...
      $ch = curl_init($this->getConfirmationUrl($country,$mode));
